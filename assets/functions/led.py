...
def function(n, block_orientation, rotate, inreverse):
...
if __name__ == "__main__":
    ...
    try:
        function(args.cascaded, args.block_orientation, args.rotate, args.reverse_order)
